...
async function reindexAll() {
  ...
  console.log(
    ...
    tracks.map((t) => ({
      ...
      cover_url: t.cover_url
        ? `${t.cover_url.slice(0, 50)}... (length: ${t.cover_url.length})`
        : null,
    }))
  );
  ...
  const body = tracks.flatMap((t) => [
    { index: { _index: "tracks", _id: t.id.toString() } },
    {
      ...
      user_ids: [],
      cover_url:
        t.cover_url && typeof t.cover_url === "string" ? t.cover_url : null,
    },
  ]);
  console.log(
    "Bulk body prepared:",
      ...
      b.index
        ...
        : {
            ...
            cover_url: b.cover_url
              ? `${b.cover_url.slice(0, 50)}... (length: ${b.cover_url.length})`
              : null,
          }
    )
  );
